...
from Dataloader.cross_domain_dl import get_sets

# ============== Get Configuration =================
def get_arg():
    cfg=argparse.ArgumentParser()
    cfg.add_argument('--exp_name',default='dgcnn_mm4_cia_crossdm_exp1', type=str)
    cfg.add_argument('--solo_base_train', action='store_true', help='train the sla merely on base classes')
    cfg.add_argument('--exp_des', default='dgcnn_mm4_cia_crossdm_exp1: cross domain exps w/ dgcnn + cia')
    ...
    cfg.add_argument('--train',action='store_false',default=True)
    ...
    cfg.add_argument('--n_shot',default=5, type=int)
    cfg.add_argument('--query',default=15, type=int)
    cfg.add_argument('--backbone',default='dgcnn_mm4',type=str, choices=['dgcnn_mm4','dgcnn','dgcnn_qmm2','bin_dgcnn_mm','dgcnn_sqmm3','dgcnn_sqmm', 'dgcnn_sqmm2', 'viewnetjj_sqmm', 'viewnet_mm', 'dgcnn_mm', 'dgcnn','viewnet'])
    cfg.add_argument('--fs_head',type=str,default='cia',choices=['bin_trip_CIA','trip_pw','Trip_CIA_sqmm','trip','bin_cia','protonet','cia','Trip_CIA_mm'])
    ...
    cfg.add_argument('--source_dataset', default='modelnet30', type=str, choices=['modelnet30','modelnet30C','shapnet40'])
    cfg.add_argument('--source_data_path',default='/home/myang47/data/ShapeNet45_fs') # 
    cfg.add_argument('--trgt_data_path',default='/home/myang47/data/scanobjectnn/ScanObjectNN_fs_cross_validation/Data')
    cfg.add_argument('--source_num_cls', default=45)
    cfg.add_argument('--trgt_num_cls', default=15)
    cfg.add_argument('--val_epoch_size', type=int, default=600)
    cfg.add_argument('--exp_folder_name',default='Shapenet_Scan_cross_domain')
    # ===================================#
...
if cfg.source_dataset == 'modelnet30':
    cfg.source_data_path = '/home/myang47/data/modelnet30'
    cfg.source_num_cls = 26
elif cfg.source_dataset == 'modelnet30C':
    cfg.source_data_path = '/home/myang47/data/ModelNet30_C'
    cfg.source_num_cls = 26
elif cfg.source_dataset == 'shapnet40':
    cfg.source_data_path = '/home/myang47/data/ShapeNet45_fs'
    cfg.source_num_cls = 44
...
def main(cfg):
    ...
    if cfg.solo_base_train:
        cfg.query = 0
    train_loader, val_loader = get_sets(source_data_path=cfg.source_data_path, trgt_data_path=cfg.trgt_data_path, source_num_cls=cfg.source_num_cls, trgt_num_cls=cfg.trgt_num_cls, k_way=cfg.k_way, n_shot=cfg.n_shot, query_num=cfg.query)
