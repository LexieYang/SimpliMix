...
from model.backbone.DGCNN_recycle import DGCNN_ref
# =============================
...
class fs_network_recycle(nn.Module):
    ...
    def forward(self,x):
        ...
        pred1,cl_loss1=self.fs_head(embeding[:,:,0],[self.s_label,self.q_label])
        pred2,cl_loss2=self.fs_head(embeding[:,:,1],[self.s_label,self.q_label])
        ...
        loss=0.5*cl_loss1+0.5*cl_loss2
...
if __name__=='__main__':
    fs_net=fs_network_recycle(k_way=5,n_shot=1,query=3,backbone='recycle',fs='protonet')
